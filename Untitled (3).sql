...
ALTER TABLE "levels" ADD FOREIGN KEY ("id") REFERENCES "courses_levels" ("level_id");

ALTER TABLE "course_video" ADD FOREIGN KEY ("id") REFERENCES "courses" ("course_video_id");
...
('partes del piano','www.courses.com/musica/piano/partes del piano');
INSERT 0 3

// USERS

coursedb=# INSERT INTO users (name, email, password, age, roles_id) VALUES ('daniel arango', 'danielito@gmail.com','morado123', 30, 2);
INSERT 0 1
coursedb=# INSERT INTO users (name, email, password, age, roles_id) VALUES ('stella carbajal', 'stella@gmail.com','m123', 20,1);
INSERT 0 1
coursedb=# INSERT INTO users (name, email, password, age, roles_id) VALUES ('ximena quintero', 'ximenita@gmail.com','l123', 45, 2);
INSERT 0 1
coursedb=# INSERT INTO users (name, email, password, age, roles_id) VALUES ('jose arango', 'josesito@gmail.com','rojo123', 28, 1);
INSERT 0 1
coursedb=# INSERT INTO users (name, email, password, age, roles_id) VALUES ('yulder armoando', 'yuyu@gmail.com', 'azul123',35,2);
INSERT 0 1
...
INSERT 0 1
coursedb=# INSERT INTO courses (title, description, teacher, category_id, course_video_id) VALUES ('piano clasico', 'instrumento de tecla',5 , 2 , 3);
INSERT 0 1
